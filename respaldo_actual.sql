...
CREATE TABLE `libros` (
  ...
  CONSTRAINT `libros_ibfk_3` FOREIGN KEY (`categoria`) REFERENCES `categoria` (`id_categoria`)
...
INSERT INTO `usuario` VALUES ('12345','Carlitos Alf','Campos','de la Garza','hola',NULL,'carlitos@alf.com',NULL),('333','Juanito','Palo','Juárez','qwerty',NULL,'foo2@example.com',NULL),('4321','gg','aa','dd','asdf',NULL,'foo@example.com',NULL),('44444','Pedro','Pedro','Juan','asdf',NULL,'asas@asd.com',NULL),('rfc del jaas','Jaasiel','Apellido xd','Apellido 3','jaasielcontra',NULL,'jaasiel@gmail.com',NULL),('rfc2 de jaas','Jaasiel2','Apellido xd','Apellido 3','hola',NULL,'jaasiel2@gmail.com',NULL);
...
-- Dump completed on 2021-05-10 16:43:44
